...
|---|---|---|
| `ezclean.setup` | op | Open the setup GUI with `/ezclean setup` |
...
| `ezclean.help` | op | View command help with `/ezclean help` |
...
- `ezclean.setup` is intentionally restricted to op-level. Granting it to staff players
  requires a permission plugin (e.g. LuckPerms).
